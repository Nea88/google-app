...
BEM.I18N.decl('appcurl-search', {"search mobile apps": 'Поиск приложений, игр...',"search": 'Найти'}, {
"lang": "ru"
});

BEM.I18N.decl('appcurl-static-links', {"explore": 'Исследуй',"apps": 'приложения',"games": 'игры',"users": 'пользователей'}, {
"lang": "ru"
});

BEM.I18N.decl('b-dropdowna', {"more": 'ещё',"or": 'или'}, {
"lang": "ru"
});

BEM.I18N.decl('b-page', {"page title": 'Appcurl  Находи лучшие Android и iPhone приложения с AppCurl – Мобильная поисковая система для социоголиков!',"username": 'Вы',"login": 'Войти',"my profile": 'Мой профиль',"settings": 'Настройки',"log out": 'Выйти'}, {
"lang": "ru"
});
...
BEM.I18N.decl('paginator', {"next": 'Вперед',"previous": 'Назад'}, {
"lang": "ru"
});

BEM.I18N.decl('popup', {"why appcurl": 'Почему Appcurl?',"what is appcurl text": 'Appcurl - поисковая система объединяет мобильные и социальные привычки пользователей, чтобы предоставить наиболее точные результаты поиска, соответствующие пользователю. Поиск Appcurl использует аналитику из нескольких источников, интернета, социальных сетей и рейтинга мобильных приложений, для того чтобы предоставить персональный список лучших Android и iPhone приложений. Appcurl это не просто поисковая система, которая обеспечивает точные и релевантные результаты, но и социальная платформа, которая позволяет находить приложения других пользователей, друзей, семьи и экспертов. С Appcurl, можно искать по ключевым словам программы, просматривать приложения по категориям или тегам, и следить за мобильными устройствами других пользователей, чтобы находить приложения в новом ключе.',"appcurl unibased text": 'Appcurl абсолютно беспристрастно. Appcurl не способствует продаже каких-либо приложений. Appcurl считает, что истинные ценители мобильных приложений являются пользователи, он поощряет их, чтобы получать опыт пользования приложениями и влиять на мир вокруг них.',"example usage": function(params) { return  }}, {
"lang": "ru"
});

BEM.I18N.decl('progress', {"searching": 'Поиск...'}, {
"lang": "ru"
});

BEM.I18N.decl('serp', {"app": 'приложение',"apps": 'приложений',"found and": ' найдено и ',"with": 'с',"in the title.": 'в заголовке',"your search": 'По вашему запросу - ',"did not match any apps": ' - приложений не найдено.',"suggestions": 'Советы:',"make sure all words are spelled correctly": 'Убедитесь что все слова написаны правильно.',"try different or more general keywords": 'Попробуйте использовать использовать другие словосочетания.',"try wild card search": 'Попробуйте использовать не точный поиск (например мат* найдет приложения математика и математический)',"try keywords in phrase within quotes": 'Попробуйте взять ключевые слова или фразу в кавычки (например: Винни-Пух найдет приложения для всей фразы Винни-Пух и не только.',"help": 'помощник',"still not sure what you are looking for": 'Все еще не уверены что ищите? Попробуйте ',"feed": 'Лента активности'}, {
"lang": "ru"
});

BEM.I18N.decl('serp-filter', {"all": 'Все',"cost": 'Стоимость',"platforms": 'Платформа',"categories": 'Категории',"rating": 'Рейтинг',"result filter": 'Фильтр результатов',"Books & Reference": 'Книги и Учебники',"Business": 'Бизнес',"Education": 'Образование',"Entertainment": 'Развлечения',"Finance": 'Финансы',"Games": 'Игры',"Health & Fitness": 'Здоровье и Фитнесс',"Lifestyle": 'Стиль жизни',"Media & Video": 'Медиа и Видео',"Medical": 'Медицина',"Music & Audio": 'Аудио и Видео',"Navigation": 'Навигация',"News & Magazines": 'Новости и Журналы',"Photography": 'Фотография',"Productivity": 'Продуктивность',"Shopping": 'Покупки',"Social": 'Социальщина',"Sports": 'Спорт',"Travel & Local": 'Путешествия',"Utilities": 'Утилиты',"Weather": 'Погода',"Personalization": 'Персонализация',"free": 'Бесплатно',"paid": 'Платно'}, {
"lang": "ru"
});

BEM.I18N.decl('serp-hint', {"your query seems too generic": 'Ваш запрос выглядит слишком обобщенным.',"narrow your search by adding more words to your query and/or by selecting result bins below": 'Вы можете сузить поиск выбрав дополнительное слово(а) из предложенных ниже.',"your query marches one of the app categories": 'Ваш запрос сходиться с одной из категории приложений. Вы можете напрямую просматривать приложения под ',"did you mean": 'Возможно вы имели ввиду ',"hint": 'Подсказка'}, {
"lang": "ru"
});

BEM.I18N.decl('serp-sort', {"relevance": 'Релевантности',"popularity": 'Популярности',"alphabetical": 'Алфавиту',"rating": 'Рейтингу',"sort by": 'Сортировать по'}, {
"lang": "ru"
});

BEM.I18N.decl('store-badges', {"it all starts here": 'Все начинается здесь.',"ios app coming soon": 'Приложение для iOs, скоро будет'}, {
"lang": "ru"
});

BEM.I18N.decl('tags', {"result bins": 'Теги'}, {
"lang": "ru"
});
