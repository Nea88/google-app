...
BEM.I18N.decl('appcurl-search', {"search mobile apps": 'Buscar apps, juegos...',"search": 'Buscar'}, {
"lang": "es"
});

BEM.I18N.decl('appcurl-static-links', {"explore": 'Explorar',"apps": 'apps',"games": 'juegos',"users": 'usuarios'}, {
"lang": "es"
});
...
BEM.I18N.decl('b-page', {"page title": 'Appcurl : Descubre las mejores apps para Android y iPhone con AppCurl – El Motor de Búsqueda Social de Apps Móviles ',"username": 'tu',"login": 'Login',"my profile": 'Mi Perfil',"settings": 'Ajustes',"log out": 'Cerrar sesión'}, {
"lang": "es"
});
...
BEM.I18N.decl('paginator', {"next": 'Siguiente',"previous": 'Anterior'}, {
"lang": "es"
});

BEM.I18N.decl('popup', {"why appcurl": 'Por qué Appcurl?',"what is appcurl text": 'El motor de búsqueda de apps Appcurl combina de forma perfecta los hábitos móviles sociales online del usuario para entregar los resultados de búsqueda más precisos y pertinentes. La búsqueda de apps Appcurl usa analíticos de múltiples fuentes; web, multimédia social y móvil; para ordenar, filtrar y entregar una lista personalizada de las mejores apps para android y iPhone. Appcurl no es solamente un motor de búsqueda de apps que entrega resultados precisos y pertinentes, sino también una plataforma social que permite descubrir apps de otros usuarios; amigos, familiares y expertos. Con Appcurl puedes buscar apps por palabra clave, por categorías o por tags, y seguir otros usuarios para descubrir apps de modo totalmente distinto.',"appcurl unibased text": ' Appcurl es totalmente imparcial. Appcurl no fomenta ni vende cualquier app. Appcurl cree que los verdaderos expertos en apps móviles son los usuarios. Appcurl anima los usuarios a manifestarse acerca de sus apps y influenciar el mundo a su alrededor.',"example usage": function(params) { return  }}, {
"lang": "es"
});

BEM.I18N.decl('progress', {"searching": 'Buscando...'}, {
"lang": "es"
});

BEM.I18N.decl('serp', {"app": 'app',"apps": 'apps',"found and": ' encontradas y ',"with": 'con',"in the title.": 'en el título.',"your search": 'Su búsqueda - ',"did not match any apps": ' – ninguna app coincide.',"suggestions": 'Sugerencias:',"make sure all words are spelled correctly": 'Compruebe que todas las palabras están bien escritas.',"try different or more general keywords": 'Intente palabras clave diferentes o más generales.',"try wild card search": 'Intente búsquedas wild card search (ejemplo: math* encontrará apps que coinciden tanto con maths como con mathematics)',"try keywords in phrase within quotes": 'Intente palabras clave en frases entre comillas (ejemplo: \'Winnie the pooh\' encontrará apps que coinciden con toda la frase y no solamente con Winnie o con Pooh.)',"help": 'Ayuda',"still not sure what you are looking for": '¿Todavía no está seguro de lo que busca? Intente el ',"feed": 'Feed'}, {
"lang": "es"
});

BEM.I18N.decl('serp-filter', {"all": 'Todo',"cost": 'Costo',"platforms": 'Plataformas',"categories": 'Categorías',"rating": 'Clasificación',"result filter": 'Filtro de Resultados',"Books & Reference": 'Libros y Obras de consulta',"Business": 'Negocios',"Education": 'Educación',"Entertainment": 'Entretenimiento',"Finance": 'Finanzas',"Games": 'Juegos',"Health & Fitness": 'Salud y Bienestar',"Lifestyle": 'Estilo de Vida',"Media & Video": 'Multimedia y Vídeo',"Medical": 'Medicinal',"Music & Audio": 'Música y Audio',"Navigation": 'Navegación',"News & Magazines": 'Noticias y Revistas',"Photography": 'Fotografía',"Productivity": 'Productividad',"Shopping": 'Compras',"Social": 'Sociedad',"Sports": 'Deportes',"Travel & Local": 'Viajes y Guías',"Utilities": 'Utilidades',"Weather": 'Tiempo',"Personalization": 'Personalización',"free": 'Gratis',"paid": 'Pagada'}, {
"lang": "es"
});

BEM.I18N.decl('serp-hint', {"your query seems too generic": 'Su búsqueda parece muy genérica.',"your query marches one of the app categories": 'Su búsqueda corresponde a una de las categorías de apps. Puede navegar directamente por las apps en ',"narrow your search by adding more words to your query and/or by selecting result bins below": 'Limite su búsqueda añadiendo más palabras à su consulta y\/o seleccionando los resultados abajo.',"did you mean": 'Quería decir ',"hint": 'Pista'}, {
"lang": "es"
});

BEM.I18N.decl('serp-sort', {"relevance": 'Relevancia',"popularity": 'Popularidad',"alphabetical": 'Alfabética',"rating": 'Classificación por estrellas',"sort by": 'Ordenar por'}, {
"lang": "es"
});

BEM.I18N.decl('store-badges', {"it all starts here": 'Todo empieza aquí.',"ios app coming soon": 'iOS app próximamente'}, {
"lang": "es"
});

BEM.I18N.decl('tags', {"result bins": 'Resultados'}, {
"lang": "es"
});
